...
if selector=="TPA":
    if area == "エンジニア":
        ...
        if talent_search :
          ...
          df_tweet = df_tweet[['name','username','text','description','url','like_count','retweet_count']]
          df_talent = df_tweet.rename(columns={'name':'ユーザー名','username':'ユーザーID','text':'ツイート本文','description':'プロフィール','url':'ツイートのURL'})
          ...
          df_talent = df_talent[df_talent['プロフィール'].str.contains('セールス|営業|テレアポ')]
